        ...
        <div class="row align-items-center" style="border: solid 1px  black; margin-bottom: 10px;" >
            ...
            <div class="col-12 col-md-6">
                <c:forEach var="photo" items="${ accvo.acc_photo_list }">
                    <!-- <div class="single-blog-thumbnail" style="text-align: center;"> -->
                        ...
                        <img src="images/${photo.acc_photo_name}"  style="width: 100px;" alt="">
                     </c:if>
                    <!-- </div> -->
                </c:forEach>
            </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="single-blog-content">
                    <!-- <div class="line"></div> -->
                    <a href="#" class="post-tag">${accvo.acc_type}</a>
                    <h4><a href="ceo_acc_detail.do?acc_idx=${accvo.acc_idx}" class="post-headline">${accvo.acc_name}</a></h4>
