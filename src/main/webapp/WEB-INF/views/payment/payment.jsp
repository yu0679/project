    ...
    <div class="container" style="margin-left:800px" >
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel"  style="width:50%;" >
          ...
          <div class="carousel-inner" >
            <div class="item active">
              <img src="../../img/core-img/tm-img-01.jpg"   alt="Los Angeles" style="width:200;">
            </div>
      
            <div class="item">
              <img src="../../img/core-img/tm-img-02.jpg" alt="Chicago" style="width:200;">
            </div>
          
            <div class="item">
              <img src="../../img/core-img/tm-img-03.jpg"  alt="New york" style="width:200;">
            </div>
          </div>
      ...
      <div id="payment">
        ...
        <tr>
            ...
            <td><input type="text" name="acc_name" id="acc_name" class="input" style="width:400px"> 
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="password" id="room_stay" name="room_stay" class="input" style="width:400px" >
            </td>
        </tr>
        <tr>
          <td width="150px"><span>인원</span><span class="star" style="margin-right: 70px">*</span>
          </td>
          <td><input type="text" name="room_person" id="room_person" class="input" style="width:400px"> 
          </td>
      </tr>
      </table>
        </form>
