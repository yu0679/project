...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			sb.append("<li><a href ='#c_menu' onclick='comment_list(" + (startPage-1) +");'>◀</a></li>");
		}
		else
			sb.append("<li class='disabled'><a href='#'>◀</a></li>");
...
//------페이지 목록 출력 -------------------------------------------------------------------------------------------------
		...
		for(int i=startPage; i<= endPage ;i++){
			...
			if(i == nowPage){ //현재 있는 페이지
				...
				sb.append("<li><a href='#c_menu' onclick='comment_list(" + i +");'>");
				sb.append(i);
				sb.append("</a></li>");
			}
		}// end for
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			sb.append("<li><a href='#c_menu' onclick='comment_list(" + (endPage+1)  +");'>▶</a></li>");
		}
		else
			sb.append("<li class='disabled'><a href='#'>▶</a></li>");
//---------------------------------------------------------------------------------------------------------------------	    
